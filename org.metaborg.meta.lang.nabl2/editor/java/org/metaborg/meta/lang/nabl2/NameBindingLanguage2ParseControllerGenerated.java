...
public class NameBindingLanguage2ParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("NameBindingLanguage2");
  ...
  { 
    NameBindingLanguage2ParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = NameBindingLanguage2ParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = NameBindingLanguage2ParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(NameBindingLanguage2ParseControllerGenerated.class);
    }
  ...
  { 
    return NameBindingLanguage2ParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
