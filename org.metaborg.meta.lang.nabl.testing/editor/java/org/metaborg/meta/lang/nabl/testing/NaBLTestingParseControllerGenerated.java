...
public class NaBLTestingParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("NaBLTesting");
  ...
  { 
    NaBLTestingParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = NaBLTestingParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = NaBLTestingParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(NaBLTestingParseControllerGenerated.class);
    }
  ...
  { 
    return NaBLTestingParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
