...
public abstract class BaseUniDisunifier implements IUniDisunifier, Serializable {
    ...
    private class Equals {
        ...
        public final IUniDisunifier other;
        ...
        public Equals(IUniDisunifier other) {
            this.other = other;
        }
    ...
    protected static class Transient implements IUniDisunifier.Transient, Serializable {
        ...
        @Override public Optional<IUnifier.Immutable> disunify(Iterable<ITermVar> universal, ITerm term1, ITerm term2) {
            final Optional<IUniDisunifier.Result<IUnifier.Immutable>> result =
                    unifier.disunify(universal, term1, term2);
            return result.map(r -> {
                unifier = r.unifier();
                return r.result();
            });
