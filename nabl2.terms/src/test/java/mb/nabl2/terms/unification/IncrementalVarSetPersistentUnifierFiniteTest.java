...
public class IncrementalVarSetPersistentUnifierFiniteTest {
    ...
    @Test(timeout = 1000) public void testEmpty() throws OccursException {
        IUnifier.Transient phi = IncrementalVarSetPersistentUnifier.Immutable.of().melt();
    ...
    @Test(timeout = 1000) public void testRemoveUnifiedVar() throws OccursException {
        ...
        IUnifier.Transient phi = new IncrementalVarSetPersistentUnifier.Transient(true, reps, Map.Transient.of(), terms,
                Set.Transient.of()).freeze().melt();
        phi.remove(b);
    ...
    @Test(timeout = 1000) public void testEquals() throws OccursException {
        ...
        phi.unify(b, x).orElseThrow(() -> new IllegalArgumentException());
        phi.unify(a, B.newAppl(f, b)).orElseThrow(() -> new IllegalArgumentException());
        IUnifier.Transient theta = IncrementalVarSetPersistentUnifier.Immutable.of().melt();
    ...
    @Test(timeout = 1000) public void testEquivalenceClasses() throws OccursException {
        final IUnifier.Immutable phi = new IncrementalVarSetPersistentUnifier.Transient(true, Map.Transient.of(a, b),
                Map.Transient.of(), Map.Transient.of(), Set.Transient.of()).freeze();
        final IUnifier.Immutable theta = new IncrementalVarSetPersistentUnifier.Transient(true, Map.Transient.of(b, a),
                Map.Transient.of(), Map.Transient.of(), Set.Transient.of()).freeze();
    ...
    @Test(timeout = 1000) public void testRemoveDisunifiedVar() throws OccursException {
        IUnifier.Transient phi = IncrementalVarSetPersistentUnifier.Immutable.of().melt();
        assertPresent(phi.disunify(a, b));
    ...
    @Test(timeout = 1000) public void testUniversalDisequality() throws OccursException {
        IUnifier.Transient phi = IncrementalVarSetPersistentUnifier.Immutable.of().melt();
    ...
    @Test(timeout = 1000) public void testUniversalDisequalityViaVarVarUnify() throws OccursException {
        IUnifier.Transient phi = IncrementalVarSetPersistentUnifier.Immutable.of().melt();
        assertPresent(phi.disunify(Iterables2.singleton(a), b, B.newAppl(f, a)));
