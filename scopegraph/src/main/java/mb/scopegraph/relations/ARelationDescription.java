...
public abstract class ARelationDescription {
    ...
    public static final RelationDescription PARTIAL_ORDER =
            RelationDescription.of(Reflexivity.REFLEXIVE, Symmetry.ANTI_SYMMETRIC, Transitivity.TRANSITIVE);

    public static final RelationDescription STRICT_PARTIAL_ORDER =
            RelationDescription.of(Reflexivity.IRREFLEXIVE, Symmetry.ANTI_SYMMETRIC, Transitivity.TRANSITIVE);
