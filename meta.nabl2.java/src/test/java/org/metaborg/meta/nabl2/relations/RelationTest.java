...
public class RelationTest {
    ...
    @Test public void testReflexive_AddRefl() throws RelationException {
        Relation.Transient<Integer> r = Relation.Transient.of(ImmutableRelationDescription.of(Reflexivity.REFLEXIVE,
    ...
    @Test(expected = ReflexivityException.class) public void testIrreflexive_ReflThrows() throws RelationException {
        Relation.Transient<Integer> r = Relation.Transient.of(ImmutableRelationDescription.of(Reflexivity.IRREFLEXIVE,
                Symmetry.NON_SYMMETRIC, Transitivity.NON_TRANSITIVE));
        r.add(1, 1);
    }
    ...
    @Test public void testNonreflexive_Refl() throws RelationException {
        Relation.Transient<Integer> r = Relation.Transient.of(ImmutableRelationDescription.of(Reflexivity.NON_REFLEXIVE,
                Symmetry.NON_SYMMETRIC, Transitivity.NON_TRANSITIVE));
        r.add(1, 1);
        assertTrue(r.contains(1, 1));
    }
