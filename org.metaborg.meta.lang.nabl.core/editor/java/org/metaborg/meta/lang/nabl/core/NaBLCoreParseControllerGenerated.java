...
public class NaBLCoreParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("NaBLCore");
  ...
  { 
    NaBLCoreParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = NaBLCoreParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = NaBLCoreParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(NaBLCoreParseControllerGenerated.class);
    }
  ...
  { 
    return NaBLCoreParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
