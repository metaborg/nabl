...
public abstract class CCheckRelation implements IRelationConstraint {
    ...
    @Override public IConstraint find(IUnifier unifier) {
        return ImmutableCCheckRelation.of(unifier.find(getLeft()), getRelation(), unifier.find(getRight()),
                getMessageInfo());
    }
