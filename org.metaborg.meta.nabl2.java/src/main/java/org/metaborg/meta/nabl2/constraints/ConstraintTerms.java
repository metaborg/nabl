...
public class ConstraintTerms {
    ...
    public static IMatcher<IConstraint> constraint() {
        return M.cases(
            ...
            M.appl5("CDeclProperty", M.term(), M.term(), M.term(), M.term(), MessageInfo.matcher(), (c, decl, key, value, prio, origin) -> {
                return ImmutableCDeclProperty.of(decl,key,value, origin);
            }),
