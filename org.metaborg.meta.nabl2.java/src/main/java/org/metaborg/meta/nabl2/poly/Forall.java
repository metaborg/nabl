...
public abstract class Forall extends AbstractApplTerm implements IApplTerm {
    ...
    @Value.Parameter public abstract Set<ITermVar> getTypeVars();
    ...
    public PSet<ITermVar> getVars() {
        return super.getVars().minusAll(getTypeVars());
    }
    
    public static IMatcher<Forall> matcher() {
        return M.appl2(OP, M.listElems(M.var()), M.term(), (t, vars, type) -> {
