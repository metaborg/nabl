...
public class RelationTest {
    ...
    @Test public void testReflexive_AddRefl() throws RelationException {
        Relation<Integer> r = new Relation<>(Reflexivity.REFLEXIVE, Symmetry.NON_SYMMETRIC,
    ...
    @Test(expected = ReflexivityException.class) public void testIrreflexive_ReflThrows() throws RelationException {
        Relation<Integer> r = new Relation<>(Reflexivity.IRREFLEXIVE, Symmetry.NON_SYMMETRIC,
                Transitivity.NON_TRANSITIVE);
        r.add(1, 1);
    }
    ...
    @Test public void testNonreflexive_Refl() throws RelationException {
        Relation<Integer> r = new Relation<>(Reflexivity.NON_REFLEXIVE, Symmetry.NON_SYMMETRIC,
                Transitivity.NON_TRANSITIVE);
        r.add(1, 1);
        assertTrue(r.contains(1, 1));
    }
    ...
    @Test public void testSymmetric_ExplicitSym() throws RelationException {
        Relation<Integer> r = new Relation<>(Reflexivity.NON_REFLEXIVE, Symmetry.SYMMETRIC,
                Transitivity.NON_TRANSITIVE);
        r.add(1, 2);
        r.add(2, 1);
        assertTrue(r.contains(1, 2));
    ...
    @Test public void testAntisymmetric_Antisym() throws RelationException {
        Relation<Integer> r = new Relation<>(Reflexivity.NON_REFLEXIVE, Symmetry.ANTI_SYMMETRIC,
                Transitivity.NON_TRANSITIVE);
        r.add(1, 2);
        r.add(2, 3);
        assertTrue(r.contains(1, 2));
    ...
    @Test public void testTransitiveSymmetric_Trans() throws RelationException {
        Relation<Integer> r = new Relation<>(Reflexivity.NON_REFLEXIVE, Symmetry.SYMMETRIC, Transitivity.TRANSITIVE);
        r.add(1, 2);
        r.add(2, 3);
        r.add(3, 4);
