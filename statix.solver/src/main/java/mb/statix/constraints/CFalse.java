...
public class CFalse implements IConstraint, Serializable {
    ...
    @Override public CFalse doSubstitute(IRenaming.Immutable localRenaming, ISubstitution.Immutable totalSubst) {
        return new CFalse(cause, message == null ? null : message.recSubstitute(totalSubst));
    }
