...
//    public Tuple2<java.util.Set<IResolutionPath<V, L, R>, >>
    ...
    private Set.Immutable<IResolutionPath<V, L, R>> env_EOP(LabelWF<L> re, IScopePath<S, L> path,
        ...
        if(relation.map(r -> !isDataComplete.test((V) scope, r)).orElse(false)) {
    ...
    private Set.Immutable<IResolutionPath<V, L, R>> env_nonEOP(L l, LabelWF<L> re, IScopePath<S, L> path,
        ...
        if(!isEdgeComplete.test((V) path.getTarget(), l)) {
    ...
    public static class Builder<S extends IOwnable, V, L, R> {
        ...
        public Builder<S, V, L, R> withEdgeComplete(Predicate2<V, L> isEdgeComplete) {
            this.isEdgeComplete = isEdgeComplete;
            return this;
        }
        ...
        public Builder<S, V, L, R> withDataComplete(Predicate2<V, R> isDataComplete) {
            this.isDataComplete = isDataComplete;
            return this;
        }
