...
public class ScopeGraphDiffer<S, L, D> {
    ...
    private void finishDiff(IScopeGraph<S, L, D> scopeGraph, Function1<D, java.util.Set<S>> getScopes,
        ...
        java.util.Set<Edge<S, L>> matchedEdges, Transient<S, Optional<D>> missedScopes,
    ...
    public static <S, L, D> ScopeGraphDiffer<S, L, D> of(Immutable<S, L, D> previous, ScopeGraphDifferOps<S, D> diffOps,
        ScopeGraphStatusOps<S, L> statusOps) {
