...
public abstract class ACConj implements IBaseConstraint {
    ...
    @Override public <T> T match(Cases<T> cases) {
        return cases.caseConj((CConj) this);
    }
    ...
    public static IConstraint of(Iterable<IConstraint> constraints) {
        IConstraint conj = CTrue.of(MessageInfo.empty());
        for(IConstraint constraint : constraints) {
            conj = CConj.of(constraint, conj, MessageInfo.empty());
        }
        return conj;
    }
