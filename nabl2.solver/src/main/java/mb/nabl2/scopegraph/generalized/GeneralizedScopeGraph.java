...
public abstract class GeneralizedScopeGraph<S extends IScope, L extends ILabel, O extends IOccurrence, V>
        implements IGeneralizedScopeGraph<S, L, O, V> {

    protected GeneralizedScopeGraph() {
    }
    ...
    public static class Immutable<S extends IScope, L extends ILabel, O extends IOccurrence, V>
            extends GeneralizedScopeGraph<S, L, O, V> implements IGeneralizedScopeGraph.Immutable<S, L, O, V>, Serializable {
        ...
        public GeneralizedScopeGraph.Transient<S, L, O, V> melt() {
            return new GeneralizedScopeGraph.Transient<>(decls.melt(), refs.melt(), directEdges.melt(), assocEdges.melt(),
        ...
        @Override public boolean equals(Object obj) {
            ...
            if(getClass() != obj.getClass())
                return false;
            @SuppressWarnings("unchecked") GeneralizedScopeGraph.Immutable<S, L, O, V> other =
                    (GeneralizedScopeGraph.Immutable<S, L, O, V>) obj;
        ...
        public static <S extends IScope, L extends ILabel, O extends IOccurrence, V>
                GeneralizedScopeGraph.Immutable<S, L, O, V> of() {
            return new GeneralizedScopeGraph.Immutable<>(HashTrieFunction.Immutable.of(), HashTrieFunction.Immutable.of(),
    ...
    public static class Transient<S extends IScope, L extends ILabel, O extends IOccurrence, V>
            extends GeneralizedScopeGraph<S, L, O, V> implements IGeneralizedScopeGraph.Transient<S, L, O, V> {
        ...
        @Override public boolean addAll(IGeneralizedScopeGraph<S, L, O, V> other) {
        ...
        public GeneralizedScopeGraph.Immutable<S, L, O, V> freeze() {
            return new GeneralizedScopeGraph.Immutable<>(decls.freeze(), refs.freeze(), directEdges.freeze(),
                    assocEdges.freeze(), importEdges.freeze(), incompleteDirectEdges.freeze(),
                    incompleteImportEdges.freeze());
        }

        public static <S extends IScope, L extends ILabel, O extends IOccurrence, V>
                GeneralizedScopeGraph.Transient<S, L, O, V> of() {
            return new GeneralizedScopeGraph.Transient<>(HashTrieFunction.Transient.of(), HashTrieFunction.Transient.of(),
