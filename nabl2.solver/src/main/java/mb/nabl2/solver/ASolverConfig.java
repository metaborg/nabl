...
public abstract class ASolverConfig {
    ...
    @Value.Parameter public abstract AResolutionParameters getResolutionParams();
    ...
    public static IMatcher<SolverConfig> matcher() {
        return M.tuple3(AResolutionParameters.matcher(), RelationTerms.relations(), FunctionTerms.functions(),
