...
import static org.metaborg.meta.nabl2.terms.Terms.TUPLE_OP;
...
public class Match {
    ...
    public static class M {
        ...
        public static IMatcher<ITerm> instantiatedTerm() {
    ...
    public static class CM {
        ...
        public static <R, E extends Throwable> ICheckedMatcher<R, E>
            ...
            return (term, unifier) -> term
                    .matchOrThrow(Terms.<Optional<R>, E>checkedCases(appl -> Optional.of(f.apply(appl)), Match::empty,
                            Match::empty, Match::empty, Match::empty, Match::empty));
        }
        ...
        public static <R, E extends Throwable> ICheckedMatcher<R, E>
            ...
            return (term, unifier) -> term.matchOrThrow(Terms.<Optional<R>, E>checkedCases(Match::empty,
                    list -> Optional.of(f.apply(list)), Match::empty, Match::empty, Match::empty, Match::empty));
        }
        ...
        public static <T, R, E extends Throwable> ICheckedMatcher<R, E> listElems(
            ...
            return (term, unifier) -> {
                return term.matchOrThrow(Terms.<Optional<R>, E>checkedCases(Match::empty, list -> {
        ...
        public static <R, E extends Throwable> ICheckedMatcher<R, E>
            ...
            return (term, unifier) -> term.matchOrThrow(Terms.<Optional<R>, E>checkedCases(Match::empty, list -> {
        ...
        public static <R, E extends Throwable> ICheckedMatcher<R, E>
            ...
            return (term, unifier) -> term.matchOrThrow(Terms.<Optional<R>, E>checkedCases(Match::empty, Match::empty,
                    Match::empty, string -> Optional.of(f.apply(string)), Match::empty, Match::empty));
        }
