[
   ...
   COMPLETION-Scope                    -- _1,
   CurrentScopeClause                  -- _1 KW["scopes"] _2,
   CurrentScopeClause.2:iter           -- _1,
   ExtendsScopeClause                  -- KW["extends"] _1 KW["scope"] KW["at"] _2,
   Children                            -- _1 KW["at"] KW["child"] KW["nodes"],
   Subsequent                          -- _1 KW["at"] KW["subsequent"] KW["nodes"],
   COMPLETION-ScopeClause              -- _1,
   COMPLETION-Scoped                   -- _1,
   True                                -- KW["true"],
   False                               -- KW["false"],
   Eq                                  -- _1 KW["=="] _2,
   Match                               -- _1 KW["=>"] _2,
   ...
   ScopeOf                             -- _1 KW["=>"] _2,
   RefersTo                            -- _1 KW["refers"] KW["to"] _2,
   Property                            -- _1 KW["has"] _2 _3,
   SubType                             -- _1 _2 _3,
   ...
   DisambiguateClause                  -- KW["disambiguates"] _1 _2 KW["by"] _3 _4,
